...
def train_generator(batch_size, train_path, image_folder, mask_folder, aug_dict,
                    ...
                    seed=1):
    """
    Can use the same seed for image_datagen and mask_datagen to ensure
...
def gen_train(image_path, mask_path, flag_multi_class=False, num_class=2, image_prefix="image",
...
def save_result(save_path, npyfile, flag_multi_class=False, num_class=2):
    for i, item in enumerate(npyfile):
        ...
        img_file = os.path.join(save_path, "%d_predict.png" % i)
